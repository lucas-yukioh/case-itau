...
public class TransferServiceImpl implements TransferService {
    ...
    public TransferResponse saveTransfer(TransferRequest transferRequest) {
        Client senderClient = clientRepository.getClientByAccountNumber(transferRequest.senderAccount())
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.BAD_REQUEST, SENDER_CLIENT_NOT_FOUND.getMessage()));

        Client receiverClient = clientRepository.getClientByAccountNumber(transferRequest.receiverAccount())
